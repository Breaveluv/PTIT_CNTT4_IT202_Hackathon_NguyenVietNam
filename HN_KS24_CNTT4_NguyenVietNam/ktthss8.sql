...
SELECT r.room_id, r.room_type, SUM((b.check_out - b.check_in) * r.price_per_day) AS doanh_thu
FROM bookings b
JOIN rooms r ON b.room_id = r.room_id
GROUP BY r.room_id;

-- Hiển thị tổng doanh thu của từng loại phòng
SELECT r.room_type, SUM((b.check_out - b.check_in) * r.price_per_day) AS tong_doanh_thu
FROM bookings b
JOIN rooms r ON b.room_id = r.room_id
